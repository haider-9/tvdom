...
<div class="min-h-screen  py-8">
  <div class="max-w-2xl mx-auto px-4">
    ...
    <form onsubmit={handleSubmit} class="space-y-8">
      <!-- Banner Section -->
      <div
        class="bg-card rounded-xl border border-gray-200 dark:border-gray-700 p-6"
      >
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                required
                class="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 "
        ...
        <div class="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows="3"
              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700  resize-none"
